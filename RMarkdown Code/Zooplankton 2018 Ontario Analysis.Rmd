...
gg_BIO_All <- ggplot(Areal_WWC_Sum_Stats, aes(x = Year, y = All_Bio_MEAN, fill = Species)) + 
...
gg_DEN_All <- ggplot(Invasive_Zoops_JKC_Sum_Stats, aes(x = Year, y = All_Den_MEAN, fill = Species))  + 
   geom_bar(color = "black", stat = "identity") + 
  #panel border, axis text and title sizes and orientations
  theme_cowplot() +
 theme(panel.border = element_rect(linetype = "solid", fill = NA), axis.text.x = element_text(size = 22, angle = 45, vjust = 1, hjust = 1), axis.title.x = element_blank(), axis.text.y = element_text(size = 22), axis.title.y = element_text(size = 26), plot.title = element_blank()) +
...
#ggsave(filename = 'Areal_WWC_Den_Zoop_Prop.TIFF', plot = gg_Rel_Zoop_Den, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")
...
#ggsave(filename = 'Areal_Epi_Bio_Stats.TIFF', plot = gg_Epi_BIO_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/CSMI-2018-Zooplankton/Figures/EPI/Areal")
...
#ggsave(filename = 'Areal_Epi_Den_Stats.TIFF', plot = gg_Epi_DEN_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/CSMI-2018-Zooplankton/Figures/EPI/Areal")
```
...
gg_Rel_Epi_Zoop_Bio
#ggsave(filename = 'Areal_Epi_Bio_Zoop_Prop.TIFF', plot = gg_Rel_Epi_Zoop_Bio, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/CSMI-2018-Zooplankton/Figures/EPI/Areal")
...
gg_Rel_Epi_Zoop_Den 
#ggsave(filename = 'Areal_Epi_Den_Zoop_Prop.TIFF', plot = gg_Rel_Epi_Zoop_Den, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/CSMI-2018-Zooplankton/Figures/EPI/Areal")
...
gg_DEN_All_Epi_Total <- ggplot(Invasive_Zoops_JKC_All_Stats, aes(x = Year, y = Zoop_All_Abun_MEAN))  + 
   geom_bar(color = "black", stat = "identity") + 
  #panel border, axis text and title sizes and orientations
  theme_cowplot() +
