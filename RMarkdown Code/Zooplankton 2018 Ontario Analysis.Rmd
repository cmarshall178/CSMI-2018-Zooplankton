...
#ggsave(filename = 'Basin_Pred_Cla_WWC_Bio.TIFF', plot = gg_BIO_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")
...
#ggsave(filename = 'Basin_Pred_Cla_WWC_Den.TIFF', plot = gg_DEN_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")
```
...
#write.csv(Areal_WWC_Zoop_Prop, file = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/CSMI-2018-Zooplankton/Processed Data/WWC/Areal_WWC_Zoop_Prop")
```


```{r zoop genera relative abundance and biomass stack graph, echo = FALSE, warning = FALSE, fig.width = 7, fig.height = 5}

Areal_WWC_Zoop_Prop$Season <- factor(Areal_WWC_Zoop_Prop$Season, levels = c("Early Spring", "Late Spring", "Early Summer", "Summer", "Late Summer", "Early Fall", "Late Fall"))

gg_Rel_Zoop_Bio <- ggplot(Areal_WWC_Zoop_Prop, aes(x = Season, y = Zoop_Prop_Bio, fill = SUMGROUP)) +
    geom_bar(color = "black", stat = "identity") + 
  theme_cowplot() +
  #panel border, axis text and title sizes and orientations
...
#ggsave(filename = 'Areal_WWC_Bio_Zoop_Prop.TIFF', plot = gg_Rel_Zoop_Bio, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")

gg_Rel_Zoop_Den <- ggplot(Areal_WWC_Zoop_Prop, aes(x = Season, y = Zoop_Prop_Abun, fill = SUMGROUP)) +
    geom_bar(color = "black", stat = "identity") + 
  theme_cowplot() +
  #panel border, axis text and title sizes and orientations
 theme(panel.border = element_rect(linetype = "solid", fill = NA), axis.text.x = element_text(size = 14, face = "bold", angle = 45, vjust = 1, hjust = 1), axis.title.x = element_blank(), axis.text.y = element_text(size = 22), axis.title.y = element_text(size = 26), plot.title = element_blank()) +
...
#ggsave(filename = 'Areal_WWC_Den_Zoop_Prop.TIFF', plot = gg_Rel_Zoop_Den, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/Figures/WWC/Areal")
...
#ggsave(filename = 'Areal_WWC_Zoop_Grid.TIFF', plot = WWC_All_Zoop_Figure, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")
```
