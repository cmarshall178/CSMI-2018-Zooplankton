...
Zoop_Bio_Den_New <- read_csv("F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Updated Raw Data/Zoop_Bio_Den_New.csv")

Areal_Bio_Den_Zoop <- read_csv("F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Updated Raw Data/Areal_Bio_Den_Zoop.csv")
...
#write.csv(Complete_Epi_Zoop_Bio_Den_New, file = "F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/Complete_Epi_Zoop_Bio_Den_New.csv")
```
...
#write.csv(Complete_WWC_Zoop_Bio_Den_New, file = "F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/Complete_WWC_Zoop_Bio_Den_New.csv")
```
...
#write.csv(Epi_Sum_Stats, file = "F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/Epi_Sum_Stats.csv")

#write.csv(Whole_Epi_Sum_Stats, file = "F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/PRED_CLA_Epi_Sum_Stats.csv")
...
#write.csv(Epi_All_Stats, file = "F:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/Epi_SumGroup_Macro_All_Stats.csv")
```
...
WWC_Sum_Stats$SUMGROUP <- factor(WWC_Sum_Stats$SUMGROUP, levels = c("LIMNO", "CALANOID", "CYCLOPOID", "CERC", "BYTH",  "DAPHNID", "BOSMINID", "NDAP"))

Whole_WWC_Sum_Stats$SPECCODE <- factor(Whole_WWC_Sum_Stats$SPECCODE, levels = c("BYTLONG", "CECPENG", "LETKIND", "POYPEDI"))

#write.csv(Whole_WWC_Sum_Stats, file = "E:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/PRED_CLA_WWC_Sum_Stats")
...
#write.csv(WWC_All_Stats, file = "E:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Processed Data/WWC_Sum_Stats")
```
...
#ggsave(filename = 'Avg_Pred_Cla_WWC_Bio.TIFF', plot = gg_BIO_All, width = 10, height = 8, path = "E:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment")

#plotting average density for all taxa from epi per month
gg_DEN_All <- ggplot(data = Whole_WWC_Sum_Stats, aes(x = Season, y = All_Den_MEAN, fill = SPECCODE))  + 
   geom_bar(color = "black", stat = "identity") + 
  #panel border, axis text and title sizes and orientations
  theme_cowplot() +
 theme(panel.border = element_rect(linetype = "solid", fill = NA), axis.text.x = element_blank(), axis.title.x = element_blank(), axis.text.y = element_text(size = 22), axis.title.y = element_text(size = 26), plot.title = element_blank()) +
...
#ggsave(filename = 'Avg_Pred_Cla_WWC_Den.TIFF', plot = gg_DEN_All, width = 10, height = 8, path = "E:/CCM Work Files - Desktop Version/CSMI Analysis/Ontario 2018/CCM Zoop Assessment/Figures")
```
