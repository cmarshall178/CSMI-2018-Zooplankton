...
#write.csv(WWC_Sum_Stats, file = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Processed Data/WWC/WWC_Sum_Stats")

#write.csv(Areal_WWC_Sum_Stats, file = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Processed Data/WWC/Areal_WWC_Sum_Stats")
...
#ggsave(filename = 'Areal_WWC_Bio_Sum_Stats.TIFF', plot = gg_BIO_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")

#plotting average density for all taxa from epi per month
gg_DEN_All <- ggplot(Areal_WWC_Sum_Stats, aes(x = Year, y = All_Den_MEAN, fill = SUMGROUP))  + 
   geom_bar(color = "black", stat = "identity") + 
  #panel border, axis text and title sizes and orientations
  theme_cowplot() +
 theme(panel.border = element_rect(linetype = "solid", fill = NA), axis.text.x = element_text(size = 22, angle = 45, vjust = 1, hjust = 1), axis.title.x = element_blank(), axis.text.y = element_text(size = 22), axis.title.y = element_text(size = 26), plot.title = element_blank()) +
#legend details 
...
#ggsave(filename = 'Invasive_Zoops_JKC_Sum_Stats.TIFF', plot = gg_DEN_All, width = 10, height = 8, path = "C:/Users/Gl Lab User/Desktop/CSMI 2018 Zooplankton/CSMI-2018-Zooplankton/Figures/WWC/Areal")
```
